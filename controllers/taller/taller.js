...
const addTaller = async (req, res) => {
    const {id_marca, taller, direccion, horario, longitud, latitud} = req.body;
    const fecha_registro = new Date();

    try{
        const query = 'INSERT INTO taller (id_marca, taller, direccion, horario, longitud, latitud) VALUES (?, ?, ?, ?, ?, ?)';
        const values = [id_marca, taller, direccion, horario, longitud, latitud, fecha_registro];
